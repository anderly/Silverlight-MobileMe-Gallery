...
namespace Gallery.Classes
{
	public class Movie : GalleryItem
	{
		...
		public Movie(record movie) : base(movie)
		{
			this.Description = movie.description;
			this.PosterPath = movie.posterPath;
			this.PosterImageHeight = movie.posterImageHeight;
			this.PosterImageWidth = movie.posterImageWidth;
			this.MimeType = movie.mimetype;
			this.RefMoviePath = movie.refMoviePath;
			this.WebImagePath = movie.webImagePath;
			this.WebImageHeight = movie.webImageHeight;
			this.WebImageWidth = movie.webImageWidth;
			this.FileExtension = movie.fileExtension;
			this.AddComment = movie.addComment;
			this.VideoPathMobile = movie.videoPathMobile;
			this.VideoHeightMobile = movie.videoHeightMobile;
			this.VideoWidthMobile = movie.videoWidthMobile;
			this.VideoDurationMobile = movie.videoDurationMobile;
			this.VideoPathSmall = movie.videoPathSmall;
			this.VideoHeightSmall = movie.videoHeightSmall;
			this.VideoWidthSmall = movie.videoWidthSmall;
			this.VideoDurationSmall = movie.videoDurationSmall;
			this.VideoPathMedium = movie.videoPathMedium;
			this.VideoHeightMedium = movie.videoHeightMedium;
			this.VideoWidthMedium = movie.videoWidthMedium;
			this.VideoDurationMedium = movie.videoDurationMedium;

		} //end public Movie(record movie) : base(movie)
